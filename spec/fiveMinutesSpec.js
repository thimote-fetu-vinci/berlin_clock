...
describe("FiveMinutes", function () {
    ...
    it("should return [true, true, true, true, true, true, true, true, true, false, false] for 45", function () {
        const result = main.fiveMinutes(main.intToMinutes(45));

        expect(result).toEqual([true, true, true, true, true, true, true, true, true, false, false]);
    });

    it("should return [true, true, true, true, true, true, true, true, true, true, false] for 50", function () {
        const result = main.fiveMinutes(main.intToMinutes(50));

        expect(result).toEqual([true, true, true, true, true, true, true, true, true, true, false]);
    });

    it("should return [true, true, true, true, true, true, true, true, true, true, true] for 55", function () {
        const result = main.fiveMinutes(main.intToMinutes(55));

        expect(result).toEqual([true, true, true, true, true, true, true, true, true, true, true]);
    });
});